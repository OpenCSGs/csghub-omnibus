...
build_time_vars = {
    ...
    'BASECPPFLAGS': '',
    'BASEMODLIBS': '',
    'BINDIR': '/opt/csghub/embedded/python/bin',
    'BINLIBDEST': '/opt/csghub/embedded/python/lib/python3.13',
    ...
    'CONFIG_ARGS': "'--prefix=/opt/csghub/embedded/python' '--enable-optimizations' '--enable-shared' '--with-ensurepip=install'",
    'CONFINCLUDEDIR': '/opt/csghub/embedded/python/include',
    'CONFINCLUDEPY': '/opt/csghub/embedded/python/include/python3.13',
    'COREPYTHONPATH': '',
    'COVERAGE_INFO': '/root/Python-3.13.2/coverage.info',
    'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
    'COVERAGE_REPORT': '/root/Python-3.13.2/lcov-report',
    'COVERAGE_REPORT_OPTIONS': '--rc lcov_branch_coverage=1 --branch-coverage --title "CPython 3.13 LCOV report [commit $(shell )]"',
    'CPPFLAGS': '-I. -I./Include',
    'CXX': 'g++',
    'DESTDIRS': '/opt/csghub/embedded/python /opt/csghub/embedded/python/lib /opt/csghub/embedded/python/lib/python3.13 /opt/csghub/embedded/python/lib/python3.13/lib-dynload',
    'DESTLIB': '/opt/csghub/embedded/python/lib/python3.13',
    'DESTPATH': '',
    'DESTSHARED': '/opt/csghub/embedded/python/lib/python3.13/lib-dynload',
    'DFLAGS': '',
    'DIRMODE': 755,
    ...
    'EXE': '',
    'EXEMODE': 755,
    'EXENAME': '/opt/csghub/embedded/python/bin/python3.13',
    'EXPORTSFROM': '',
    'EXPORTSYMS': '',
    'EXTRATESTOPTS': '',
    'EXTRA_CFLAGS': '',
    ...
    'INCLDIRSTOMAKE': '/opt/csghub/embedded/python/include /opt/csghub/embedded/python/include /opt/csghub/embedded/python/include/python3.13 /opt/csghub/embedded/python/include/python3.13',
    'INCLUDEDIR': '/opt/csghub/embedded/python/include',
    'INCLUDEPY': '/opt/csghub/embedded/python/include/python3.13',
    ...
    'LDVERSION': '3.13',
    'LIBC': '',
    'LIBDEST': '/opt/csghub/embedded/python/lib/python3.13',
    'LIBDIR': '/opt/csghub/embedded/python/lib',
    ...
    'LIBOBJDIR': 'Python/',
    'LIBOBJS': '',
    'LIBPC': '/opt/csghub/embedded/python/lib/pkgconfig',
    'LIBPL': '/opt/csghub/embedded/python/lib/python3.13/config-3.13-x86_64-linux-gnu',
    'LIBPYTHON': '',
    ...
    'MACHDEP': 'linux',
    'MACHDEP_OBJS': '',
    'MACHDESTLIB': '/opt/csghub/embedded/python/lib/python3.13',
    'MACOSX_DEPLOYMENT_TARGET': '',
    'MAJOR_IN_MKDEV': 0,
    'MAJOR_IN_SYSMACROS': 1,
    'MAKESETUP': './Modules/makesetup',
    'MANDIR': '/opt/csghub/embedded/python/share/man',
    'MIMALLOC_HEADERS': '\\',
    ...
    'RESSRCDIR': '',
    'RETSIGTYPE': 'void',
    'RUNSHARED': 'LD_LIBRARY_PATH=/root/Python-3.13.2:/opt/csghub/embedded/python/lib:',
    'SCRIPTDIR': '/opt/csghub/embedded/python/lib',
    ...
    'TESTOPTS': '',
    'TESTPATH': '',
    'TESTPYTHON': 'LD_LIBRARY_PATH=/root/Python-3.13.2:/opt/csghub/embedded/python/lib: ./python -E',
    'TESTPYTHONOPTS': '',
    'TESTRUNNER': 'LD_LIBRARY_PATH=/root/Python-3.13.2:/opt/csghub/embedded/python/lib: ./python -E -m test',
    ...
    'VERSION': '3.13',
    'WASM_ASSETS_DIR': './opt/csghub/embedded/python',
    'WASM_STDLIB': './opt/csghub/embedded/python/lib/python3.13/os.py',
    'WHEEL_PKG_DIR': '',
    'WINDOW_HAS_FLAGS': 0,
    ...
    'abs_builddir': '/root/Python-3.13.2',
    'abs_srcdir': '/root/Python-3.13.2',
    'datarootdir': '/opt/csghub/embedded/python/share',
    'exec_prefix': '/opt/csghub/embedded/python',
    'prefix': '/opt/csghub/embedded/python',
    'srcdir': '.',
}
