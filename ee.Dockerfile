...
ARG CSGHUB_VERSION=v2.4.0-ee
ARG CSGHUB_SERVER_VERSION=v2.4.0-ee
ARG CSGHUB_PORTAL_VERSION=v2.4.0-ee
...
ARG NATS_VERSION=2.12.12
ARG CASDOOR_VERSION=3.62.0
...
RUN mkdir -p \
      ...
      ${CSGHUB_SRV_HOME}/{registry,nats,temporal,temporal_ui,casdoor,dnsmasq,consul,server,portal,prometheus,loki,xnet,backup}/bin
