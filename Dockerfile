...
ARG CSGHUB_VERSION=v2.5.0-ce
ARG CSGHUB_SERVER_VERSION=v2.5.0-ce
ARG CSGHUB_PORTAL_VERSION=v2.5.0-ce
ARG RUNIT_VERSION=2.3.1
ARG TOOLBOX_VERSION=1.4.3
ARG CONSUL_VERSION=1.20.5
ARG MINIO_VERSION=RELEASE.2025-09-07T16-13-09Z
ARG POSTGRESQL_VERSION=16.15
ARG REDIS_VERSION=7.4.11
ARG REGISTRY_VERSION=2.8.3
ARG GITALY_VERSION=v17.5.0
ARG GITLAB_SHELL_VERSION=v19.2.5
ARG TEMPORAL_VERSION=1.32.0
ARG NATS_VERSION=2.12.15
ARG CASDOOR_VERSION=3.62.1
...
RUN /scripts/install-packages.sh ce
